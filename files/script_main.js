...
function load() {
  ...
  exponent_reinforce_requirement = parseInt(localStorage.getItem('exponent_reinforce_requirement'), 10);
...
function save() {
  ...
  localStorage.setItem('exponent_reinforce_requirement', exponent_reinforce_requirement.toString());
